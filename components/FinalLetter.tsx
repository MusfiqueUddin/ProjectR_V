        ...
        <div className="relative z-10 w-full max-w-2xl transition-all duration-600 opacity-100 translate-y-0">
          ...
          >
            ...
            <article className="handwriting text-sm sm:text-base text-[#1b0d14] leading-relaxed space-y-4">
              ...
              <p>
                Today I don’t just want to say “I love you.” I want to promise you something deeper.
              </p>
              <p className="text-[#5a9bb8]">
                I promise to always care for you, respect you, and stand by your side. I promise to be honest, to listen to you, and to support you in everything you do. No matter what happens, I will choose you and our love every single day.
              </p>
              <p>
